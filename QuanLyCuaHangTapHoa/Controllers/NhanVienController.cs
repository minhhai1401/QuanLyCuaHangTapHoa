...
namespace QuanLyCuaHangTapHoa.Controllers
{
    public class NhanVienController : Controller
    {
        ...
        public ActionResult Create(NhanVien nhanvien, HttpPostedFileBase file)
        {
            if (ModelState.IsValid)
            {
                ...
                if (file != null && file.ContentLength > 0)
                {
                    ...
                    var path = Path.Combine(Server.MapPath("~/Hinh/NhanVien"), fileName);
                    file.SaveAs(path);
                    nhanvien.Picture = fileName; // Lưu tên file vào thuộc tính Picture
                }
        ...
        public ActionResult Detail(int? id)
        {
            ...
            NhanVien nhanVien = _db.NhanViens
                .AsNoTracking()
                .Include(n => n.ChucVu)
