...
namespace QuanLyCuaHangTapHoa.Others
{
    public class PayLib
    {
        ...
        public string CreateRequestUrl(string baseUrl, string vnp_HashSecret)
        {
            ...
            baseUrl += "?" + queryString;
            string vnp_SecureHash = ConfigParser.Sha256(vnp_HashSecret + rawData);
        ...
        public bool ValidateSignature(string inputHash, string secretKey)
        {
            ...
            string myChecksum = ConfigParser.Sha256(secretKey + rspRaw);
